...
async function testMediumJSSite() {
    // Test with a medium complexity JS site
    const requestBody = {
        url: 'https://news.ycombinator.com', // Medium complexity
        options: {
            mobile: false,
            screenshot: false
        }
    ...
    console.log('🚀 Testing with medium JS site (Hacker News)...');
